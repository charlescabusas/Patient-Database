...
if ($_SERVER['REQUEST_METHOD'] == "POST"){
	...
	try {
		require_once "../patient-test/patient_info_config.php";
		...
		$pdo = null;
		$stmt = null;
		header("Location: ../patient-test/patient_form_display.php");
...
else header("Location: ../patient-testpatient_index.php");
